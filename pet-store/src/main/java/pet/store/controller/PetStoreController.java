...
public class PetStoreController {
    ...
    @DeleteMapping("/{petStoreId}") // Map DELETE requests to this method
    public Map<String, String> deletePetStoreById(@PathVariable Long petStoreId) {
        log.info("Deleting pet store with ID: {}", petStoreId);
        petStoreService.deletePetStoreById(petStoreId); // Call service method to delete
        return Map.of("message", "Pet store deleted successfully"); // Return success message
    }
